...
typealias ListQuery = privmx.endpoint.core.PagingQuery //for brevity
...
// The static method Connection.connect(userPrivKey:solutionId:platformUrl:) returns a connection object, that is required to initialise other modules
guard var connection = try? Connection.connect(userPrivKey: userPK, solutionId: solutionID, platformUrl: bridgeURL) as? Connection
else {exit(1)}
